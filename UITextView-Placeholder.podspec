#
#  Be sure to run `pod spec lint UITextView-Placeholder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Moseschan/UITextView-Placeholder"
  ...
  s.source       = { :git => "https://github.com/Moseschan/UITextView-Placeholder.git", :tag => "0.0.1" }
